...
public class RecordDS {
    ...
    public static Record map(RecordDS recordDS) {
        return Record.builder()
                ...
                .customer(User.builder().id(recordDS.getCustomerId()).build())
                .manager(User.builder().id(recordDS.getManagerId().orElse(null)).build())
                .service(Service.builder().id(recordDS.getServiceId()).build())
